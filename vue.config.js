...
module.exports = {
    pluginOptions: {
        ...
        //ADMIN_API_ROOT: "http://localhost:57021/api/haa/",
        ADMIN_API_ROOT: "http://84521.ddns.net/dev.HAAApi/api/haa/",
        ADMIN_API_GET_REQUEST_COUNT: "RequestCount/{0}/{1}",
        MAP_API_ROOT: "http://84521.ddns.net/dev.HAAApi/api/haa/",
        //MAP_API_ROOT: "http://localhost:57021/api/haa/",
